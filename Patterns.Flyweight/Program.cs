...
namespace Patterns.Flyweight
{
    ...
    class PanelHouse : House
    {
        ...
        {
            Console.WriteLine("Build panel house from 16 floors; coordinates: {0} latitude and {1} longitude",
                latitude, longitude);
        }
    }
    class BrickHouse : House
    {
        ...
        public override void Build(double longitude, double latitude)
        {
            Console.WriteLine("Build brick house from 5 floors; coordinates: {0} latitude and {1} longitude",
                latitude, longitude);
        }
    }
